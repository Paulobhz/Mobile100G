...
type
  TLibrary = class
    ...
    public
      class procedure OpemForm(const AFormClass: TComponentClass; ATarget: TFMXObject);
...
class procedure TLibrary.OpemForm(const AFormClass: TComponentClass; ATarget: TFMXObject);
